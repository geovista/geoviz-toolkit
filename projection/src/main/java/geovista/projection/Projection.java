...
import geovista.projection.units.AngleFormat;
...
public class Projection implements Cloneable {
	 ...
	 */
	protected double standardParallel1 = 0.0;

	/**
	 * Standard parallel 2 (for projections which use it)
	 */
	protected double standardParallel2 = 0.0;
	 ...
	 * metres
	 */
	public void transform(double[] srcPoints, int srcOffset,
	...
	public boolean inside(double x, double y) {
		...
		return minLongitude <= x && x <= maxLongitude && minLatitude <= y
				&& y <= maxLatitude;
	}
