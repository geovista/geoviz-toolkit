...
public class PolygonShape implements Shape {
	 ...
	 *            a Coordinate[] for each hole, in view coordinates
	 */
	...
	private GeneralPath toPolygon(Coordinate[] coordinates) {
		...
		for (Coordinate coordinate : coordinates) {
			...
			polygon.lineTo((float) coordinate.x, (float) coordinate.y);
		}
