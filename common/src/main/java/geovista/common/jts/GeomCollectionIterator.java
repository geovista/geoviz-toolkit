 ...
 * @author Andrea Aime
 * @source $URL:
 *         http://svn.geotools.org/geotools/trunk/gt/modules/library/main/src/main/java/org/geotools/geometry/jts/GeomCollectionIterator.java $
 * 
 */
public final class GeomCollectionIterator extends AbstractLiteIterator {
	...
	private final EmptyIterator emptyIterator = new EmptyIterator();
	...
	public void init(GeometryCollection gc, AffineTransform at,
		...
		currentIterator = gc.isEmpty() ? emptyIterator : getIterator(gc
				.getGeometryN(0));
	}
