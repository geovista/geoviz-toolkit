 ...
 * @source $URL:
 *         http://svn.geotools.org/geotools/trunk/gt/modules/library/main/src/main/java/org/geotools/geometry/jts/PolygonIterator.java $
 * 
 */
public final class PolygonIterator extends AbstractLiteIterator {
	...
	public int currentSegment(double[] coords) {
		// first make sure we're not at the last element, this prevents us from
		// exceptions
